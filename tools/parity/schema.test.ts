...
import { modelValidate, type Schema } from "../../.claude/skills/sssf/templates/adws/adw_modules/compat/schema.ts";
import { GenericOutput, ScoutOutput, SSSF_CONFIG } from "../../.claude/skills/sssf/templates/adws/adw_modules/dataTypes.ts";
