...
```ts
#!/usr/bin/env bun
const DOC = `ADW Plan Build — plan the request, then implement the plan.`;
...
1. `bun adws/adw_<name>.ts "a tiny real request"` — watch it go green end to end.
